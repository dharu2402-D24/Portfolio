    ...
    >
      ...
      >
        <button
          ...
          className={`group relative block w-full text-left rounded-2xl overflow-hidden bg-[#141414] border border-white/[0.06] transition-colors ${
            isOpenable
        ...
        >
          ...
          <div className="relative aspect-[4/3] overflow-hidden bg-[#111111]">
            {hasImage && (
              <img
                ...
                className={`w-full h-full object-cover transition-transform duration-[900ms] ease-[cubic-bezier(0.22,1,0.36,1)] ${
                  isOpenable ? "group-hover:scale-110" : ""
                }`}
                style={{
            ...
            {hasImage && (
              <div
                className={`absolute inset-0 bg-gradient-to-t from-[#0d0d0d] via-transparent to-transparent opacity-60 transition-opacity duration-500 ${
                  isOpenable ? "group-hover:opacity-40" : ""
                }`}
              />
            )}
          </div>
